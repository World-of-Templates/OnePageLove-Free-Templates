...
class Parallel_Feature_Widget extends WP_Widget {
    ...
    function __construct() {
		...
		$this->defaults = array(
			'title'      => __('Feature Title', 'parallel' ),
			'text'       => __('fa-paper-plane-o', 'parallel' ),
			'image_url'  => '',
			'textarea'   => __('Quis autem vel eum iure reprehen derit qui in ea voluptate velit esse quam nihil molestiae consequatur.', 'parallel' ),
		);
...
?>
	<p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Feature Title', 'parallel'); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $instance['title']; ?>" />
    </p>
    <p>
        <label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('Feature Icon Class', 'parallel'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('image_url'); ?>"><?php _e('Feature Image', 'parallel'); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('textarea'); ?>"><?php _e('Feature Description', 'parallel'); ?></label>
...
// End of Widget Class
add_action( 'widgets_init', create_function( '', "register_widget( 'Parallel_Feature_Widget' );" ) );
?>